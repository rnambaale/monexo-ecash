...
impl Dhke {
    ...
    pub fn hash_to_curve(message: &[u8]) -> Result<PublicKey, MonexoCoreError> {
        ...
        (0..2u32.pow(16))
            ...
            .ok_or(MonexoCoreError::NoValidPointFound)
    }
    ...
    ) -> Result<PublicKey, MonexoCoreError> {
    ...
    pub fn step2_bob(&self, b: PublicKey, a: &SecretKey) -> Result<PublicKey, MonexoCoreError> {
        b.mul_tweak(&self.secp, &Scalar::from(*a))
            .map_err(MonexoCoreError::Secp256k1Error)
    }
